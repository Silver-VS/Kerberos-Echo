...
- [`Controllers.Kerberos.Client.Controller`](../src/main/java/Controllers/Kerberos/Client/Controller.java) – full
  client-side flow.
- `Controllers.Kerberos.`[`AS`](../src/main/java/Controllers/Kerberos/AS/ProcessRequest.java)/[
  `TGS`](../src/main/java/Controllers/Kerberos/TGS/ProcessRequest.java)/[
  `Server`](../src/main/java/Controllers/Kerberos/Server/ProcessRequest.java)`.ProcessRequest` – server-side logic.
- [`Model.UTicket`](../src/main/java/Model/UTicket.java) – how tickets are built, encrypted and decrypted.
- [`Security.Model.KeyMethods`](../src/main/java/Security/Model/KeyMethods.java) – how keys are created and stored.
